        ...
        <form action="m_ubah_pengguna.php" method="post">
            ...
            <table>
                <tr>
                    <td>Nama</td>
                    <td>:</td>
                    <td><input type="text" name="nama" id="" class="form-control" value="<?= $pengguna['nama_pengguna'] ?>"></td>
                </tr>
                <tr>
                    <td>Username</td>
                    <td>:</td>
                    <td><input type="text" name="username" id="" class="form-control" value="<?= $pengguna['username_pengguna'] ?>"></td>
                </tr>
                <tr>
                    <td>Password</td>
                    <td>:</td>
                    <td><input type="text" name="password" id="" class="form-control" value="<?= $pengguna['password_pengguna'] ?>"></td>
                </tr>
                <tr>
                    <td>Status</td>
                    <td>:</td>
